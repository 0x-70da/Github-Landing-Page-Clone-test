...
const OpenSourceContent = ({display, onHover, onLeave}) => {
        if(!display){
        return null;
    }
  return (
    <div className={`py-5 px-3 rounded-2xl bg-gray-50 text-gray-800 flex justify-between max-w-100 absolute left-82`} onMouseOver={onHover} onMouseLeave={onLeave}>
        <div>
